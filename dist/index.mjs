  ...
  return /* @__PURE__ */ React2.createElement(
    ...
    schema.pages.map((page) => {
      ...
      return /* @__PURE__ */ React2.createElement(
        ...
        headerSchema && /* @__PURE__ */ React2.createElement(View2, { fixed: true }, (_e = headerSchema.pages[0]) == null ? void 0 : _e.children.map((child) => renderNode(child, context))),
        page.children.map((child) => renderNode(child, context)),
        footerSchema && /* @__PURE__ */ React2.createElement(View2, { fixed: true, style: { marginTop: "auto" } }, (_f = footerSchema.pages[0]) == null ? void 0 : _f.children.map((child) => renderNode(child, context)))
      );
    })
  );
};
